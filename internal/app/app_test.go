...
func TestListBackupsNewestFirst(t *testing.T) {
	...
	origHomeDirFn := osUserHomeDir
	t.Cleanup(func() { osUserHomeDir = origHomeDirFn })
...
func TestListBackupsWithSourceMetadata(t *testing.T) {
	...
	t.Cleanup(func() { osUserHomeDir = origHomeFn })
	osUserHomeDir = func() (string, error) { return home, nil }
...
func TestRunArgsRestoreByIDWithYes(t *testing.T) {
	...
	// Override both app and cli osUserHomeDir since RunArgs delegates to cli.RunRestore.
	origAppHomeFn := osUserHomeDir
	restoreCliHome := cli.OverrideUserHomeDirForTest(home)
	t.Cleanup(func() {
		osUserHomeDir = origAppHomeFn
		restoreCliHome()
	})
	osUserHomeDir = func() (string, error) { return home, nil }
